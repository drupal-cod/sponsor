...
namespace Drupal\sponsors\Plugin\Block;
...
/**
 * Provides a Sponsors by Level block.
 *
 * @Block(
 *   id = "sponsors_by_level",
 *   admin_label = @Translation("Sponsors by Level")
 * )
 */
class SponsorsByLevel extends BlockBase implements ContainerFactoryPluginInterface {
