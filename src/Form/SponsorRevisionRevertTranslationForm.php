...
class SponsorRevisionRevertTranslationForm extends SponsorRevisionRevertForm {
  ...
  /**
   * Constructs a new SponsorRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return 'sponsor_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $sponsor_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $sponsor_revision);
